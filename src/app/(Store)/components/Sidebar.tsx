...
import VideoCard from './ProductCard'
    ...
    return (
        <>
            ...
            <div className='flex flex-row '>
                <aside id="separator-sidebar" className=" fixed     w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
