    ...
    return (
        <div className="p-4 ">
            <div className="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                <section className="h-fit bg-gray-100 py-12 sm:py-16 lg:py-20">
                            ...
                            <div className="bg-white shadow">
                                <div className="px-4 py-6 sm:px-8 sm:py-10">
                                    ...
                                    <div className="mt-6 flex items-center justify-between">
                                        ...
                                        <p className="text-2xl font-semibold text-gray-900"><span className="text-xs font-normal text-gray-400">USD</span>{totalCost}</p>
                                    </div>
